...
% dlmwrite(strcat('/data/Projects/Torso/meshes/midwallFibrosis/myoSCARLV_MIXED_C',num2str(lowerPhi),'_',num2str(upperPhi),'_',num2str(lowerRho),'_',num2str(upperRho),'_',num2str(lowerZ),'_',num2str(upperZ),'.elem'),length(torsoElemsScar),'precision',9,'delimiter',' ');
% dlmwrite(strcat('/data/Projects/Torso/meshes/midwallFibrosis/myoSCARLV_MIXED_C',num2str(lowerPhi),'_',num2str(upperPhi),'_',num2str(lowerRho),'_',num2str(upperRho),'_',num2str(lowerZ),'_',num2str(upperZ),'.elem'),torsoElemsScar,'-append','precision',9,'delimiter',' ');
% 
% dlmwrite(strcat('/data/Projects/Torso/meshes/midwallFibrosis/myoSCARLV_MIXED_C',num2str(lowerPhi),'_',num2str(upperPhi),'_',num2str(lowerRho),'_',num2str(upperRho),'_',num2str(lowerZ),'_',num2str(upperZ),'.lon'),1,'precision',9,'delimiter',' ');
% dlmwrite(strcat('/data/Projects/Torso/meshes/midwallFibrosis/myoSCARLV_MIXED_C',num2str(lowerPhi),'_',num2str(upperPhi),'_',num2str(lowerRho),'_',num2str(upperRho),'_',num2str(lowerZ),'_',num2str(upperZ),'.lon'),torsoFibresScar,'-append','precision',9,'delimiter',' ');

dlmwrite(strcat('meshes/myoSCARLV_MIXED_C',num2str(lowerPhi),'_',num2str(upperPhi),'_',num2str(lowerRho),'_',num2str(upperRho),'_',num2str(lowerZ),'_',num2str(upperZ),'.elem'),length(torsoElemsScar),'precision',9,'delimiter',' ');
dlmwrite(strcat('meshes/myoSCARLV_MIXED_C',num2str(lowerPhi),'_',num2str(upperPhi),'_',num2str(lowerRho),'_',num2str(upperRho),'_',num2str(lowerZ),'_',num2str(upperZ),'.elem'),torsoElemsScar,'-append','precision',9,'delimiter',' ');

dlmwrite(strcat('meshes/myoSCARLV_MIXED_C',num2str(lowerPhi),'_',num2str(upperPhi),'_',num2str(lowerRho),'_',num2str(upperRho),'_',num2str(lowerZ),'_',num2str(upperZ),'.lon'),1,'precision',9,'delimiter',' ');
dlmwrite(strcat('meshes/myoSCARLV_MIXED_C',num2str(lowerPhi),'_',num2str(upperPhi),'_',num2str(lowerRho),'_',num2str(upperRho),'_',num2str(lowerZ),'_',num2str(upperZ),'.lon'),torsoFibresScar,'-append','precision',9,'delimiter',' ');
